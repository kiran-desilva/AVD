...
K_ws =                  % 0.75[(1 + 2λ)/(1 + λ)]Bw tan Λ/L
K_y =                   % Aircraft pitching radius of gyration; ≈ 0.3Lht (ft)
K_z =                   % Aircraft yaw radius of gyration; ≈ Lvt (ft)
L =                     % Fuselage structural length (ft)
...
Nm =                    % Number of mechanical function performed by controls; typically 0 − 2
...
V_t =                   % Total volume of fuel tanks (gal)
...
W_seat = fuselage.seat_lb       % Weight of single seat (lb); ≈ 60 for flight deck seats, 32 for passenger seats, and 11 for troop seats
