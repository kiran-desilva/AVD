...
loiterfrac = 1;
for i = 1:7
    loiterfrac = roskam.fuelfrac(i) * loiterfrac;
end

cruisefrac = 1;
for i = 1:6
    cruisefrac = roskam.fuelfrac(i) * cruisefrac;
end
 
Vloiter = (sqrt(0.311 * ((p.parameters.cruise_mach * 295.07 / (3^0.25))^2) / (((loiterfrac * roskam.W0) / (cruisefrac * roskam.W0)) * 1.058))) * 1.94384; %knts
